...
#define DEFAULT_AGENT_SIZE 1000
#define TAMER_HORSE_ARCHER_AGENT_SIZE 4200
...
#define AZAPS_START_Y 15.3
#define AZAPS_START_X 4
#define OTTO_SECOND_LINE_START_Y 14.5
#define SERB_CAL_START_Y 14.2
#define SERB_CAL_START_X 1.5

#define TAMERLANE_DEFAULT_START_Y 22.5
#define TAMERLANE_DEFAULT_START_X 2

#define TAMERLANE_SECOND_LINE_Y 23
#define TAMERLANE_SECOND_LINE_X 3
#define TAMERLANE_RESERVE_Y 24
